...
#define MULL_MUTANTS_INFO_SECTION_NAME_STR MULL_XCTEST_METADATA_TOSTR(MULL_MUTANTS_INFO_SECTION_NAME)
#define MULL_MUTANTS_INFO_SECTION MACHO_SECTION(__DATA, MULL_MUTANTS_INFO_SECTION_NAME)
