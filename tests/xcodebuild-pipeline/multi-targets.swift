...
// RUN-CHECK: DynamicFramework/Library.swift:3:16: warning: Survived: Replaced > with >= [cxx_gt_to_ge]
// RUN-CHECK: DynamicFramework/Library.swift:3:16: warning: Survived: Replaced > with <= [cxx_gt_to_le]
// RUN-CHECK: StaticFramework/StaticFramework.swift:2:16: warning: Survived: Replaced > with >= [cxx_gt_to_ge]
// RUN-CHECK: StaticFramework/StaticFramework.swift:2:16: warning: Survived: Replaced > with <= [cxx_gt_to_le]
