...
// RUN: mull-xctestrun --test-target DynamicFrameworkTests -Xxcodebuild -destination -Xxcodebuild "platform=iOS Simulator,name=iPhone 8" %t/Build/Products/MultiTargets_iphonesimulator14.4-x86_64.xctestrun | FileCheck %s --check-prefix=RUN-CHECK
