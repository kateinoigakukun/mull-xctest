...
// RUN: xcodebuild test-without-building -destination "%iossim-dest" -xctestrun %t/Build/Products/StaticFramework_iphonesimulator14.4-x86_64.xctestrun
...
// RUN: mull-xctestrun --test-target StaticFrameworkTests -Xxcodebuild -destination -Xxcodebuild "platform=iOS Simulator,name=iPhone 8" %t/Build/Products/StaticFramework_iphonesimulator14.4-x86_64.xctestrun | FileCheck %s --check-prefix=RUN-CHECK
